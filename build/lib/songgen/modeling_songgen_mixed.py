...
class SongGenMixedForConditionalGeneration(PreTrainedModel):
    ...
    def __init__(
        ...
        self.add_prenet = config.add_prenet
        logger.info(f'****SongGenForConditionalGeneration add_prenet:{self.add_prenet}')
        ...
        **kwargs,
        ...
        if prompt_hidden_states is None:
            if prompt_input_ids is not None:
                ...
                prompt_hidden_states = self.encode_lyrics(prompt_input_ids, prompt_attention_mask, add_prenet =self.add_prenet)
